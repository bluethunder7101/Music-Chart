...
<!-- Project Phase 3 Script to display the various podcasts that have been favorited by users --> 
            ...
            <table class="table table-hover"> 
                <thead> 
                    <tr class="table-success"> 
                        ...
                        <th scope="col" style="background-color:#1a1a1a; color:#8d8b86">Creator</th>
						<th scope="col" style="background-color:#1a1a1a; color:#8d8b86">PodCastID</th>						
                    </tr>
                </thead> 
                <?php 
					...
					//SQL to generate username, creator, podcastid to see what users favorite what podcasts.
					$sql = " SELECT
							   Username,
							   Creator,
							   PodcastID
